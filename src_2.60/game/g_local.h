...
struct gentity_s {
	...
	float		wait;
	float		random;
	int             numPlayers; // minimum clients in trigger_multiple bounds
	int             etxmapAutogeneratedName;
	int             etxmapFixedDuplicatedName;
...
typedef struct {
    ...
    qboolean nitmodDemoClient; /* Original private flag, refreshed from sv_demoState/Clients. */
