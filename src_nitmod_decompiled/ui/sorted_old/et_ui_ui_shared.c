...
{  float tmp_f1;
  ...
  tmp_f5 = (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 96, 4);
  if (((float)GHIDRA_FIELD(jP_GrenadesPerLevel, 96, 4) != (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 100, 4)) &&
     ((tmp_u7 & 2) != 0)) {
    tmp_f5 = (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 100, 4);
  }
  if (((float)GHIDRA_FIELD(jP_GrenadesPerLevel, 104, 4) != (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 100, 4)) &&
     ((tmp_u7 & 4) != 0)) {
    tmp_f5 = (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 104, 4);
  }
  if (((float)GHIDRA_FIELD(jP_GrenadesPerLevel, 108, 4) != (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 104, 4)) &&
     ((tmp_u7 & 8) != 0)) {
    tmp_f5 = (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 108, 4);
  }
  if (((float)GHIDRA_FIELD(jP_GrenadesPerLevel, 112, 4) != (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 108, 4)) &&
     ((tmp_u7 & 0x10) != 0)) {
    tmp_f5 = (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 112, 4);
  }
  if (((float)GHIDRA_FIELD(jP_GrenadesPerLevel, 116, 4) != (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 112, 4)) &&
     ((tmp_u7 & 0x20) != 0)) {
    tmp_f5 = (float)GHIDRA_FIELD(jP_GrenadesPerLevel, 116, 4);
  }
  tmp_i8 = tmp_i14 * 0x18;
...
LAB_0001809e:
    tmp_i8 = 1;
    if ((tmp_u7 & 0x20) != 0) {
      tmp_i8 = GHIDRA_FIELD(ammoTableMP, 72, 4);
    }
    if (tmp_i10 < tmp_i8) {
    ...
    if (tmp_i8 != 0) {
      tmp_i8 = GHIDRA_FIELD(ammoTableMP, 792, 4);
      if ((*(byte *)(param_2 + 8) & 4) != 0) {
        tmp_i8 = GHIDRA_FIELD(ammoTableMP, 792, 4) + 2;
      }
      if (GHIDRA_FIELD(bg_itemlist, 56, 4) != 0) {
...
LAB_0001819c:
    ...
    if (tmp_i8 != 0) {
      tmp_i8 = GHIDRA_FIELD(ammoTableMP, 3096, 4);
      if ((*(byte *)(param_2 + 8) & 4) != 0) {
        tmp_i8 = GHIDRA_FIELD(ammoTableMP, 3096, 4) + 2;
      }
      if (GHIDRA_FIELD(bg_itemlist, 56, 4) != 0) {
        tmp_pi13 = (int *)(bg_itemlist + 0x38);
        do {
...
LAB_000185d8:
      ...
      if (*(int *)(tmp_i8 + 0x290) < (int)GHIDRA_FIELD(ammoTableMP, 3384, 4)) {
        if (param_4 == 0) goto LAB_00017fde;
        tmp_i10 = *(int *)(tmp_i8 + 0x290) + param_4;
        if ((int)GHIDRA_FIELD(ammoTableMP, 3384, 4) < tmp_i10) {
          tmp_b6 = true;
          *(uint32_t *)(tmp_i8 + 0x290) = GHIDRA_FIELD(ammoTableMP, 3384, 4);
          tmp_b15 = true;
        }
        else {
...
LAB_00018477:
            ...
            tmp_pi12 = (int *)(bg_itemlist + 0x38);
            tmp_i9 = GHIDRA_FIELD(bg_itemlist, 56, 4);
            while (tmp_i9 != 0) {
  ...
  *param_2 = 1.0;
  ...
  if ((*param_1 == '0') && ((param_1[1] & 0xdfU) == 0x58)) {
    ...
    while (tmp_pu5 != (uint8_t *)0x0) {
      ...
      if (tmp_i7 == 0) {
        *param_2 = *(float *)(&g_ptr_colorWhite_00066e24)[tmp_i8 * 2];
        param_2[1] = *(float *)((&g_ptr_colorWhite_00066e24)[tmp_i8 * 2] + 4);
        param_2[2] = *(float *)((&g_ptr_colorWhite_00066e24)[tmp_i8 * 2] + 8);
        return;
      }
      tmp_i8 = tmp_i8 + 1;
