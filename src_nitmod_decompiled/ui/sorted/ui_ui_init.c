...
void String_Init(void) {
  ...
  if ((DC != 0) && (*(int *)(DC + 0xb8) != 0)) {
    tmp_ppu7 = (uint32_t **)&g_dat_000693f8;
    do {
      tmp_ppu8 = tmp_ppu7 + 8;
      (**(void **)(DC + 0xbc))(tmp_ppu7[-6],tmp_ppu7,tmp_ppu7 + 1);
      tmp_ppu7 = tmp_ppu8;
    } while (tmp_ppu8 != &PTR_DAT_00069b98);
  }
  return;
}
...
void UI_RegisterCvars(void) {
  ...
  if (0 < cvarTableSize) {
    ...
    do {
      ...
      if (*tmp_ppu1 != (uint32_t *)0x0) {
        tmp_ppu1[4] = *(uint32_t **)(*tmp_ppu1 + 4);
      }
      tmp_i2 = tmp_i2 + 1;
      tmp_ppu1 = tmp_ppu1 + 5;
...
void _UI_Init(void) {
  ...
  if (0 < cvarTableSize) {
    ...
    do {
      ...
      if (*tmp_ppu8 != (uint32_t *)0x0) {
        tmp_ppu8[4] = *(uint32_t **)(*tmp_ppu8 + 4);
      }
      tmp_i9 = tmp_i9 + 1;
      tmp_ppu8 = tmp_ppu8 + 5;
