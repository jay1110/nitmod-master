...
#define NAMEDBUTTON( NAMEDBUTTON_NAME, NAMEDBUTTON_X, NAMEDBUTTON_Y, NAMEDBUTTON_W, NAMEDBUTTON_H, NAMEDBUTTON_TEXT, NAMEDBUTTON_TEXT_SCALE, NAMEDBUTTON_TEXT_ALIGN_Y, NAMEDBUTTON_ACTION )					\
	itemDef {															\
		...
		mouseEnter {													\
			...
			setitemcolor NAMEDBUTTON_NAME backcolor .2 .2 .2 .9			\
		}																\
																		\
		mouseExit {														\
			setitemcolor NAMEDBUTTON_NAME forecolor .6 .6 .6 1 ;		\
			setitemcolor NAMEDBUTTON_NAME backcolor .1 .1 .1 .9			\
		}																\
																		\
		action {														\
			setitemcolor NAMEDBUTTON_NAME forecolor .6 .6 .6 1 ;		\
...
#define NAMEDBUTTONEXT( NAMEDBUTTONEXT_NAME, NAMEDBUTTONEXT_X, NAMEDBUTTONEXT_Y, NAMEDBUTTONEXT_W, NAMEDBUTTONEXT_H, NAMEDBUTTONEXT_TEXT, NAMEDBUTTONEXT_TEXT_SCALE, NAMEDBUTTONEXT_TEXT_ALIGN_Y, NAMEDBUTTONEXT_ACTION, NAMEDBUTTONEXT_EXT )					\
	itemDef {															\
		...
		mouseEnter {													\
			...
			setitemcolor NAMEDBUTTONEXT_NAME backcolor .2 .2 .2 .9		\
		}																\
																		\
		mouseExit {														\
			setitemcolor NAMEDBUTTONEXT_NAME forecolor .6 .6 .6 1 ;		\
			setitemcolor NAMEDBUTTONEXT_NAME backcolor .1 .1 .1 .9		\
		}																\
																		\
		action {														\
			setitemcolor NAMEDBUTTONEXT_NAME forecolor .6 .6 .6 1 ;		\
...
#define MULTIALIGN( MULTI_X, MULTI_Y, MULTI_W, MULTI_H, MULTI_TEXT, MULTI_TEXT_SCALE, MULTI_TEXT_ALIGN_X, MULTI_TEXT_ALIGN_Y, MULTI_CVAR, MULTI_CVARLIST, MULTI_TOOLTIP )	\
    itemDef {															\
		name			"multi"##MULTI_TEXT								\
      	group			GROUP_NAME										\
		rect			$evalfloat(MULTI_X) $evalfloat(MULTI_Y) $evalfloat(MULTI_W) $evalfloat(MULTI_H)	\
		...
		textscale		MULTI_TEXT_SCALE								\
		textalign		ITEM_ALIGN_RIGHT								\
		textalignx		$evalfloat(0.5*(MULTI_W)+(MULTI_TEXT_ALIGN_X))						\
		textaligny		MULTI_TEXT_ALIGN_Y								\
		forecolor		.6 .6 .6 1										\
		cvar			MULTI_CVAR										\
		MULTI_CVARLIST													\
...
#define LABELWHITEB( LABELWHITE_X, LABELWHITE_Y, LABELWHITE_W, LABELWHITE_H, LABELWHITE_TEXT, LABELWHITE_TEXT_SCALE, LABELWHITE_TEXT_ALIGN, LABELWHITE_TEXT_ALIGN_X, LABELWHITE_TEXT_ALIGN_Y )	\
    itemDef {															\
		name			"labelwhite"##LABELWHITE_TEXT					\
      	group			GROUP_NAME										\
		rect			$evalfloat(LABELWHITE_X) $evalfloat(LABELWHITE_Y) $evalfloat(LABELWHITE_W) $evalfloat(LABELWHITE_H)	\
...
#define CREDIT( LABELWHITE_X, LABELWHITE_Y, LABELWHITE_W, LABELWHITE_H, LABELWHITE_TEXT, LABELWHITE_TEXT_SCALE, LABELWHITE_TEXT_ALIGN, LABELWHITE_TEXT_ALIGN_X, LABELWHITE_TEXT_ALIGN_Y )	\
    itemDef {															\
		name			"credits"##LABELWHITE_TEXT					\
      	group			GROUP_NAME										\
		rect			$evalfloat(LABELWHITE_X) $evalfloat(LABELWHITE_Y) $evalfloat(LABELWHITE_W) $evalfloat(LABELWHITE_H)	\
		type			ITEM_TYPE_TEXT									\
		text			LABELWHITE_TEXT									\
